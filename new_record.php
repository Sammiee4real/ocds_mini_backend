<?php require_once('config/instantiated_files.php');
       ...
       if(isset($_POST['cmd_add_record'])){
            ...
            $add_new_record =  add_new_record($mdas,$contractor,$date11,$tender_title,$tender_description,$tender_value_amount,$tender_award_value,$parties_address_street_address);
            $add_new_record_dec = json_decode($add_new_record,true);
         if($add_new_record_dec['status'] == 111){
              $msg = "<div class='alert alert-success' >".$add_new_record_dec['msg']." | <a href='new_record.php'>refresh</a></div><br>";
            // $msg = "success";
          }else{
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add a New Record <!-- &lt;h4&gt; -->   </h1>
            <blockquote contenteditable="true">sam of God</blockquote>
